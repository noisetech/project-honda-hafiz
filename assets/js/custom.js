...
(function ($) {
  ...
  $(".courses-slider").owlCarousel({
    ...
    autoplayTimeout: 500, // setiap 1 detik pindah slide
    smartSpeed: 500, // kecepatan transisi slide
    autoplayHoverPause: true,
    navText: [
      '<i class="ri-arrow-left-line"></i>',
      '<i class="ri-arrow-right-line"></i>',
  ...
  $(".courses-produk").owlCarousel({
    ...
    thumbs: false,
    // autoplay: true, // aktifkan autoplay
    // autoplayTimeout: 900, // setiap 1 detik pindah slide
    // smartSpeed: 500, // kecepatan transisi slide
    // autoplayHoverPause: true,
    navText: [
      '<i class="ri-arrow-left-line"></i>',
  ...
  $(".courses-keahlian-progamming").owlCarousel({
    loop: true,
    margin: 20,
    nav: true,
    dots: false,
